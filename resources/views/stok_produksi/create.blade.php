...
@section('sub-title' , 'Tambah Stok Produksi')
@section('content')

        <form action="/stok-produksi" method="POST" class="">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="jumlah_stok_produksi" name="jumlah_stok_produksi" placeholder="Masukan Jumlah Produksi">
            </div>
            <button type="submit" class="btn btn-primary btn-block">Simpan</button>
            <a href="{{ route('stok_produksi.index') }}" class="btn btn-secondary btn-block">Batal</a>
        </form>
